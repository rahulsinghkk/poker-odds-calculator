...
[![Node version required](https://img.shields.io/node/v/poker-odds.svg)](https://www.npmjs.com/package/poker-variants-odds-calculator)
...
```bash
npm install -g poker-variants-odds-calculator
```
